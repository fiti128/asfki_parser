...
public class Db2lWriterImpl extends Writer implements Db2Writer {
	private static String DEFAULT_DELIMETER = "|";
	private String columnDelimeter = DEFAULT_DELIMETER;
	private BufferedWriter bw;

	Db2lWriterImpl(BufferedWriter bw) {
		this.bw = bw;
	}

	Db2lWriterImpl(BufferedWriter bw, String columnDelimeter) {
		this.bw = bw;
